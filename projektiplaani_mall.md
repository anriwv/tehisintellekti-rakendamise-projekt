...
> Vaja on infot kõikide antud hetkel Tartu Ülikoolis õpetatavate ainete kohta (vähemalt terve aasta, eelistatult viimased 2 aastat), mis **sisaldaks detailset infot, näiteks kestuse, õppekava/õppeastme kuuluvust, õppekeele, semestri, kas aine toimub kohapeal või veebis, sõltuvust ainetest jne.** Andmed saab alla laadida Tartu Ülikooli õppeinfosüsteemi API kaudu ning andmed on avalikult kättesaadavad.
